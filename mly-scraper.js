...
const N8N_WEBHOOK_URL = "http://localhost:5678/webhook/mly-jobstreet-ingest";
...
async function runScraper() {
    console.log("🚀 Starting Deep Local Malaysian JobStreet Scraper...");
    ...
    // caching file
    const CACHE_FILE = "mly_scraped_jobs_cache.json";
